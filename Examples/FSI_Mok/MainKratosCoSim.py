...
class CustomCoSimulationAnalysis(CoSimulationAnalysis):
    ...
    def OutputSolutionStep(self):
        ...
        wet_interface_sub_model_part = model_part.GetSubModelPart("interface")
        ...
        solution_A = self.node_A.GetSolutionStepValue(KM.DISPLACEMENT_X)

        self.time_history.append(current_time)
        self.disp_x_history_A.append(solution_A)

        # --- Evaluate displacement at B ---
        solution_B = self.node_B.GetSolutionStepValue(KM.DISPLACEMENT_X)
